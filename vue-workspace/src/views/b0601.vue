      ...
      <el-form :model="b0601Form" ref="loginForm" label-position="left" autocomplete="on">
        <el-main class="b0601_body">
          <div class="b0601_select">
            ...
            <div class="select_body">
              <el-row :gutter="1">
                <el-col :span="6" :offset="1">
                  <div>
                    <el-form-item label="説明会方式：" label-width="100px">
                      <el-select v-model="b0601Form.briefingType" placeholder="選択してください" clearable>
                        <el-option v-for="item in briefing_type" :key="item.value" :label="item.label"
                          :value="item.value" />
                      </el-select>
                    </el-form-item>
                  </div>
                ...
                <el-col :span="6" :offset="1">
                  <div>
                    <el-form-item label="説明会状態：" label-width="100px">
                      <el-select v-model="b0601Form.statusFlg" placeholder="選択してください" clearable>
                        <el-option v-for="item in briefing_status" :key="item.value" :label="item.label"
                          :value="item.value" />
                      </el-select>
                    </el-form-item>
                  </div>
                ...
                <el-col :span="6" :offset="1">
                  <el-form-item label="キーワード検索：" label-width="120px">
                    <el-input v-model="b0601Form.keyWord" placeholder="キーワード検索" clearable />
                  </el-form-item>
                </el-col>
                <!-- //22/07/01 wuyz add end -->
              </el-row>
              <el-row :gutter="1">
                <el-col :span="6" :offset="1">
                  <div>
                    <el-form-item label="説明会日：" label-width="100px">
                      <el-date-picker v-model="b0601Form.briefingDate" type="date" placeholder="説明会日"
                ...
                <el-col :span="6" :offset="1">
                  <div>
                    <el-form-item label="説明会時間：" label-width="110px">
                      <el-time-picker is-range v-model="b0601Form.date" range-separator="-" start-placeholder="開始時間"
                        end-placeholder="終了時間" value-format="HH:mm:ss" style="width: 280px" clearable />
                    </el-form-item>
                  </div>
                </el-col>
              </el-row>
          ...
          <div class="b0601_data">
            <div class="data_body">
              <template>
                <el-table ref="multipleTable" :data="getBriefingList"
                  :default-sort="{ prop: 'b0601Date', order: 'descending' }" @row-click="getRowData"
                  @row-dblclick="toB0602Detailed" tooltip-effect="dark" @selection-change="selectionChange"
                  ...
                  <el-table-column v-if="false" prop="briefingId" label="説明会ID" sortable />
                  ...
                  <el-table-column fixed="right" width="50">
                    <el-tooltip effect="light" content="説明会応募者一覧へ" placement="top">
              ...
              <el-row type="flex" justify="space-around">
                <el-col :span="12">
                  <el-pagination :total="pagination.total" :current-page="pagination.currentPage"
                    ...
                    :page-size="pagination.pageSize" :background="true" :layout="pagination.layout"
...
export default {
  ...
  methods: {
    ...
    setBriefingData() {
      ...
      //
      this.B0601VueForm.keyWord = this.b0601Form.keyWord;
      //
    },
